...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://pixabay.com/vectors/anime-animation-cartoon-character-3708780/.jpg" ; // SET LOGO FOR IMAGE 
...
global.userImages= process.env.USER_IMAGES || "https://chat.whatsapp.com/JydJljUwQ1EA9p5hGZL9q9.jpg" // ramadan Theme Images
...
module.exports = {
  ...
  caption : process.env.CAPTION || "@Enoch/Ralph" , 
 
  author : process.env.PACK_AUTHER|| "Enoch/Ralph",
  packname: process.env.PACK_NAME || "♥️",
  botname : process.env.BOT_NAME  || "Genius",
